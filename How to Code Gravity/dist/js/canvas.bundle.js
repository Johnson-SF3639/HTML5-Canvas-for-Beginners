...
var colorArray = ['red', 'blue', 'green', 'yellow', 'white', 'black', 'pink', 'lightblue', 'orange', 'navy', 'aqua']; // const colors = ['#2185C5', '#7ECEFD', '#FFF6E5', '#FF7F66'];
...
function init() {
  ...
  for (var i = 0; i < 400; i++) {
    ...
    var color = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomColor"])(colorArray);
